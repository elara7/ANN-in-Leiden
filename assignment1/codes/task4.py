...
import pandas as pd
import os
os.chdir('C:\\Users\\elara\\mydata\\documents\\2016-2017(2)\\201702-201707\\ANN-in-Leiden\\assignment1\\data')
...
# 迭代（don't run)-------------------------------------------------------------
while (((falsepos != 0) | (falseneg != 0)) & (iter_num <= 100)): #进入条件，仍有错分，且迭代次数不超过10000
